...
#End Region
    ...
    Public Function InsertAction(ByVal action As Action) As Integer
        Return AgentBD.getAgent.Insert("INSERT INTO acciones VALUES(" & action.IdAction & ",'" & action.Action & "');")
    End Function

    Public Sub ReadAction()
        'Buenas prácticas mencionan el uso de Using para cerrar y liberar recursos cuando se hace una consulta (si no cambiar lo de multiply y listo)'
        Using reader As MySql.Data.MySqlClient.MySqlDataReader = AgentBD.getAgent.Read("SELECT id_accion FROM acciones")
    ...
    Public Function InsertFocus(ByVal focus As Focus) As Integer
        Return AgentBD.getAgent.Insert("INSERT INTO catalogo_focos VALUES(" & focus.IdFocus & ",'" & focus.Focus & "');")
    End Function

    Public Sub ReadFocus()
        Using reader As MySql.Data.MySqlClient.MySqlDataReader = AgentBD.getAgent.Read("SELECT * FROM catalogo_focos")
            If reader.HasRows Then
                While reader.Read
